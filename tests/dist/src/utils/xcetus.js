...
class XCetusUtil {
    ...
    static buildLockCetus(data) {
        ...
        lockCetus.lock_day = (lockCetus.locked_until_time - lockCetus.locked_start_time) / xcetus_type_1.ONE_DAY_SECONDS;
        return lockCetus;
    }
    static getAvailableXCetus(veNTF, locks) {
        ...
        return (0, numbers_1.d)(veNTF.xcetus_balance).sub(lockAmount).toString();
    }
    ...
    static getNextStartTime(dividendManager) {
        ...
        const currentPeriod = (0, numbers_1.d)(currentTime)
            ...
            .div((0, numbers_1.d)(dividendManager.interval_day).mul(24 * 3600))
            .toFixed(0, decimal_js_1.default.ROUND_UP);
        const nextStartTime = (0, numbers_1.d)(dividendManager.start_time).add((0, numbers_1.d)(currentPeriod).mul(24 * 3600));
        return nextStartTime;
    }
}
exports.XCetusUtil = XCetusUtil;
