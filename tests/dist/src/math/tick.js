...
exports.tickScore = exports.getTickDataFromUrlData = exports.TickMath = void 0;
...
class TickMath {
    static priceToSqrtPriceX64(price, decimalsA, decimalsB) {
        return utils_2.MathUtil.toX64(price.mul(decimal_1.default.pow(10, decimalsB - decimalsA)).sqrt());
    }
    static sqrtPriceX64ToPrice(sqrtPriceX64, decimalsA, decimalsB) {
        return utils_2.MathUtil.fromX64(sqrtPriceX64)
            .pow(2)
            .mul(decimal_1.default.pow(10, decimalsA - decimalsB));
    }
...
function getTickDataFromUrlData(ticks) {
    ...
    for (const tick of ticks) {
        const td = {
            ...
            index: Number((0, utils_1.asIntN)(BigInt(tick.index)).toString()),
...
function tickScore(tickIndex) {
    return (0, utils_1.d)(tickIndex).add((0, utils_1.d)(TICK_BOUND));
}
