...
exports.findBestSplitSteps = void 0;
const utils_1 = require("./utils");
// TODO: recursion to find the max amout out router
function findBestSplitSteps(routerTable, feeRateArray, poolAddresses, exceedTable, a2b, byAmountIn) {
    ...
    let tempAmount = byAmountIn ? utils_1.ZERO : utils_1.U64_MAX;
    let tempPath = [];
    switch (numRows) {
        case 1: {
    ...
    if (tempPath.length === 0 || tempAmount.eq(utils_1.ZERO)) {
        return {
            stepAmount: utils_1.ZERO,
            splitSteps: [],
            isExceed: true,
        };
    }
...
exports.findBestSplitSteps = findBestSplitSteps;
