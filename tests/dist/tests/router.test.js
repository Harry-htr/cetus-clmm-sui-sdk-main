...
describe('Router Module', () => {
    ...
    test('router module => testnet', () => __awaiter(void 0, void 0, void 0, function* () {
        ...
        const amount = new bn_js_1.default('1000000');
        ...
        // console.log(result)
        const result = yield sdk.Router.price(USDT, USDC, amount, byAmountIn, 1, '');
        console.log(result === null || result === void 0 ? void 0 : result.amountIn.toString(), result === null || result === void 0 ? void 0 : result.amountOut.toString());
        logPath(result.paths);
        if (!(result === null || result === void 0 ? void 0 : result.isExceed)) {
            const allCoinAsset = yield sdk.Resources.getOwnerCoinAssets(sdk.senderAddress);
            const routerPayload = src_1.TransactionUtil.buildRouterSwapTransaction(sdk, sdk.Router.getCreateTxParams(), byAmountIn, allCoinAsset);
            (0, src_1.printTransaction)(routerPayload);
            const signer = new sui_js_1.RawSigner(sendKeypair, sdk.fullClient);
            const transferTxn = yield (0, src_1.sendTransaction)(signer, routerPayload);
