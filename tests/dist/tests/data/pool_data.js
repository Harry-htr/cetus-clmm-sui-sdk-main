...
exports.tokenList = exports.poolList = void 0;
const init_test_data_1 = require("./init_test_data");
exports.poolList = [
    {
        coin_type_a: `${init_test_data_1.faucetObjectId}::usdt::USDT`,
        coin_type_b: `${init_test_data_1.faucetObjectId}::usdc::USDC`,
        coin_a_decimals: 6,
        coin_b_decimals: 6,
        initialize_price: 1,
        tick_spacing: 2,
    ...
    {
        coin_type_a: `${init_test_data_1.faucetObjectId}::btc::BTC`,
        coin_type_b: `${init_test_data_1.faucetObjectId}::usdc::USDC`,
        coin_a_decimals: 8,
        coin_b_decimals: 6,
    ...
    {
        coin_type_a: `${init_test_data_1.faucetObjectId}::eth::ETH`,
        coin_type_b: `${init_test_data_1.faucetObjectId}::usdc::USDC`,
        coin_a_decimals: 8,
        coin_b_decimals: 6,
    ...
    {
        coin_type_a: `${init_test_data_1.faucetObjectId}::usdc::USDC`,
